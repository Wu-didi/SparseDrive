...
log_level = "INFO"
work_dir = "./work_dirs/sparsedrive_small_stage2_exp25"
...
planning_guided_completion_cfg = dict(
    ...
    trajectory_source="pred",             # 用模型自身预测轨迹（stop-grad）引导补全
...
model = dict(
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            ...
            motion_loss_reg=dict(type='L1Loss', loss_weight=0.1),
            ...
            plan_loss_status=dict(type='L1Loss', loss_weight=0.2),
...
evaluation = dict(
    interval=num_iters_per_epoch*checkpoint_epoch_interval,
    # ihterval = num_iters_per_epoch*num_epochs,
    eval_mode=eval_mode,
)
# ================== pretrained model ========================
load_from = 'work_dirs/sparsedrive_small_stage2_exp22/iter_140650.pth'
